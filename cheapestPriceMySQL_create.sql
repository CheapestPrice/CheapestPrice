...
CREATE TABLE ITEMS_LISTA (
    ...
    CONSTRAINT ITEMS_LISTA_pk PRIMARY KEY (ITEMS_PRODUCTOS_id,ITEMS_TIENDAS_x,ITEMS_TIENDAS_y,ITEMS_TIENDAS_nit,USUARIOS_correo)
);
...
CREATE TABLE LISTAS_MERCADOS (
    ...
    USUARIOS_correo varchar(100) NOT NULL,
    ITEMS_LISTA_ITEMS_PRODUCTOS_id bigint NOT NULL,
    ITEMS_LISTA_ITEMS_TIENDAS_x double(100,10) NOT NULL,
    ITEMS_LISTA_ITEMS_TIENDAS_y double(100,10) NOT NULL,
    ITEMS_LISTA_ITEMS_TIENDAS_nit varchar(100) NOT NULL,
    ITEMS_LISTA_USUARIOS_correo varchar(100) NOT NULL,
    CONSTRAINT LISTAS_MERCADOS_pk PRIMARY KEY (nombre,USUARIOS_correo,ITEMS_LISTA_ITEMS_PRODUCTOS_id,ITEMS_LISTA_ITEMS_TIENDAS_x,ITEMS_LISTA_ITEMS_TIENDAS_y,ITEMS_LISTA_ITEMS_TIENDAS_nit,ITEMS_LISTA_USUARIOS_correo)
);
...
-- Reference: ITEMS_LISTA_USUARIOS (table: ITEMS_LISTA)
ALTER TABLE ITEMS_LISTA ADD CONSTRAINT ITEMS_LISTA_USUARIOS FOREIGN KEY ITEMS_LISTA_USUARIOS (USUARIOS_correo)
...
-- Reference: LISTAS_MERCADOS_ITEMS_LISTA (table: LISTAS_MERCADOS)
ALTER TABLE LISTAS_MERCADOS ADD CONSTRAINT LISTAS_MERCADOS_ITEMS_LISTA FOREIGN KEY LISTAS_MERCADOS_ITEMS_LISTA (ITEMS_LISTA_ITEMS_PRODUCTOS_id,ITEMS_LISTA_ITEMS_TIENDAS_x,ITEMS_LISTA_ITEMS_TIENDAS_y,ITEMS_LISTA_ITEMS_TIENDAS_nit,ITEMS_LISTA_USUARIOS_correo)
    REFERENCES ITEMS_LISTA (ITEMS_PRODUCTOS_id,ITEMS_TIENDAS_x,ITEMS_TIENDAS_y,ITEMS_TIENDAS_nit,USUARIOS_correo);
...
-- Reference: TIENDAS_OPINIONES (table: TIENDAS)
ALTER TABLE TIENDAS ADD CONSTRAINT TIENDAS_OPINIONES FOREIGN KEY TIENDAS_OPINIONES (OPINIONES_id)
    REFERENCES OPINIONES (id);
