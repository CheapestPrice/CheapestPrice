...
public class UserPersistenceHibernate implements UserPersistence{
    ...
    @Override
    public void favoriteShoppingListItem(int itemListaId ,int tiendaId, int listaMercadoId, boolean fav) throws CheapestPriceException {
        ilR.favoriteItemSelected(itemListaId,tiendaId,listaMercadoId ,fav);
    }
    ...
    public void sellSelectedItem(int itemListaId, long idProducto, int id, boolean comp) throws CheapestPriceException {
        ilR.sellItemSelected(itemListaId,id,comp);
    }
